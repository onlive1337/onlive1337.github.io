...
const HeroContent = memo(function HeroContent() {
 return (
   <div className="text-center space-y-4">
     ...
     <p className="max-w-2xl mx-auto text-gray-600 dark:text-gray-400 flex items-center justify-center gap-2">
       smol femboy dev <span className="text-xl">🦊</span> from <span className="text-xl">🇺🇿</span>
